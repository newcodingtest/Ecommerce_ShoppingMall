...
import com.yoon.shopping.service.CartService;
...
public class CartController {
    ...
    @ApiOperation(value = "장바구니 등록 API")
    ...
    @ApiOperation(value = "장바구니 등록 페이지 이동")
    ...
    @ApiOperation(value = "장바구니 수정 API")
    ...
    public @ResponseBody ResponseEntity orderCartItem(@RequestBody CartOrderDto cartOrderDto,
        ...
        Long orderId = cartService
                .orderCartItem(cartOrderDtoList, principal.getName());
